...
HoodIndex2HoodName = {v: k for k, v in list(HoodId2HoodIndex.items())}
HoodIndex2HoodId = None
if HoodIndex2HoodId == None:
    HoodIndex2HoodId = {}
    for hoodName in list(HoodId2HoodIndex.keys()):
...
HoodIndex2LevelRange = {
    ...
    hi2hi[MinniesMelodyland]: list(range(2, 6 + 1)),
    hi2hi[DaisyGardens]: list(range(2, 6 + 1)),
    hi2hi[DonaldsDock]: list(range(2, 6 + 1))
}
