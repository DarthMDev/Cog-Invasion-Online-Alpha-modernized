    ...
    def generateBody(self, suitType, suitTeam, suitHead, skeleton):
        ...
        if suitType == "A":
            ...
            self.loadAnims({"neutral": "phase_4/models/char/suitA-neutral.bam",
                            ...
                            "squirt-small" : "phase_4/models/char/suitA-squirt-small.bam"}, "body")
        if suitType == "B":
            if skeleton:
            ...
            self.loadAnims({"neutral": "phase_4/models/char/suitB-neutral.bam",
                            ...
                            "squirt-small" : "phase_4/models/char/suitB-squirt-small.bam"}, "body")
        if suitType == "C":
            if skeleton:
            ...
            self.loadAnims({"neutral": "phase_3.5/models/char/suitC-neutral.bam",
                        ...
                        "squirt-small" : "phase_3.5/models/char/suitC-squirt-small.bam"}, "body")
        if skeleton:
            self.setTwoSided(1)
