...
class DistributedDoor(DistributedObject.DistributedObject):
    ...
    def generated(self):
        ...
        self.doorOpenSound = base.audio3d.loadSfx('phase_3.5/audio/sfx/Door_Open_1.mp3')
        self.doorShutSound = base.audio3d.loadSfx('phase_3.5/audio/sfx/Door_Close_1.mp3')
