...
animations = [
    ...
    Anim(5, 'throw-object', suitTypes = [SuitType.A, SuitType.B]),
    Anim(5, 'throw-paper'),
    Anim(5, 'glower', suitTypes = [SuitType.A, SuitType.C]),
    Anim(5, 'pickpocket'),
    Anim(7, 'fountain-pen', suitTypes = [SuitType.A, SuitType.C], name = 'fountainpen'),
    Anim(5, 'phone'),
