...
..\Panda3D-CI\python\ppython.exe -m direct.showutil.pfreeze -i direct.*.* -i lib.coginvasion.*.* -i encodings.* -i base64 -i site -o tools\libcoginvasion.pyd -x panda3d __main__
