...
class ControlManager:
    ...
    def enable(self):
        ...
        if self.wantWASD:
            ...
            #ist.append(inputState.watchWithModifiers("slideLeft", "e", inputSource=inputState.QE))
            #ist.append(inputState.watchWithModifiers("slideRight", "q", inputSource=inputState.QE))
